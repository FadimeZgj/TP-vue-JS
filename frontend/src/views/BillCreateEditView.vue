    ...
    <div class="bill" v-if="!loading && bill">
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <div class="form-floating mb-3">
            <select name="client" id="client" class="form-control" placeholder="Client" v-model="bill.client"
      ...
      <TableList>
        ...
        <tr v-for="(prestation, index) in bill.prestations" :key="index">
          <td class="align-middle">
            ...
            <button :disabled="bill.prestations.length === 1" @click="onRemovePrestation(index)"
